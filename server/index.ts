...
console.log("Thirdweb AUTH Private Key",process.env.THIRDWEB_AUTH_PRIVATE_KEY)
console.log("Thirdweb Auth Domain",process.env.THIRDWEB_AUTH_DOMAIN)
...
app.use('/auth', (req, res, next) => {
  console.log(`Incoming request to /auth: ${req.method} ${req.path}`);
